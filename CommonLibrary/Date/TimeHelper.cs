...
namespace CommonLibrary
{
    ...
    public class TimeHelper
    {
        ...
        /// <param name="Separator">年月日分隔符</param>
        /// <returns></returns>
        public static string GetFormatDate(char Separator)
        {
            return GetFormatDate(DateTime.Now, Separator);
        }
        ...
        /// <param name="Separator">分隔符</param>
        /// <returns></returns>
        public static string GetFormatTime(char Separator)
        {
            return GetFormatDate(DateTime.Now, Separator);
        }
        #endregion
        ...
        {
            int Day = new System.Globalization.GregorianCalendar().GetDaysInMonth(year, month);
            return Day;
        }
        #endregion
        ...
        public static void ReturnDateFormat(int month, out string firstDay, out string lastDay)
        {
            ...
            lastDay = year + "-" + month.ToString().PadLeft(2, '0') + "-" + GetMonthLastDate(year, month).ToString().PadLeft(2, '0');
            firstDay = year + "-" + month.ToString().PadLeft(2, '0') + "-01";
        }
        #endregion
    }
}
