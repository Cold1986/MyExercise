...
namespace CommonLibrary
{
    class PDFOperationHelper
    {
        ...
        public PDFOperationHelper(string type)
        {
            SetPageSize(type);
            document = new Document(rect);
        }
        ...
        public PDFOperationHelper(string type, float marginLeft, float marginRight, float marginTop, float marginBottom)
        {
            SetPageSize(type);
