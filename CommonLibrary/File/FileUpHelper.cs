...
namespace CommonLibrary
{
    ...
    public class FileUpHelper
    {
        ...
        //---------------------------------------------
        public static void UploadFile(byte[] binData, string fileName, string fileType)
        {
        ...
        public static string UploadFile(FileUpload PosPhotoUpload, string saveFileName, string imagePath)
        {
            string state = "";
        ...
        public static string GetUploadFileName()
        {
            ...
            Result += time.Year.ToString() + time.Month.ToString().PadLeft(2, '0') + time.Day.ToString().PadLeft(2, '0') + time.Hour.ToString().PadLeft(2, '0') + time.Minute.ToString().PadLeft(2, '0') + time.Second.ToString().PadLeft(2, '0') + time.Millisecond.ToString().PadLeft(3, '0');
            return (Result);
        }
        #endregion
